defmodule PrimaAuth0Ex.TokenProvider.ProbabilisticRefreshStrategyTest do
  ...
  test "refresh time is randomic" do
    ...
    assert ProbabilisticRefreshStrategy.refresh_time_for(:client, token) !=
             ProbabilisticRefreshStrategy.refresh_time_for(:client, token)
  end
  ...
  property "refresh always happens during the lifetime of the token" do
    check all(
      ...
      refresh_time = ProbabilisticRefreshStrategy.refresh_time_for(:client, token)
