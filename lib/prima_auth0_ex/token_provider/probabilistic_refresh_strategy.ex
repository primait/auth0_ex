defmodule PrimaAuth0Ex.TokenProvider.ProbabilisticRefreshStrategy do
  ...
  defp min_token_duration, do: :prima_auth0_ex |> Application.get_env(:client, []) |> Keyword.get(:min_token_duration, 0.5)
  defp max_token_duration, do: :prima_auth0_ex |> Application.get_env(:client, []) |> Keyword.get(:max_token_duration, 0.75)
end
