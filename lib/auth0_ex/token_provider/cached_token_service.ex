defmodule Auth0Ex.TokenProvider.CachedTokenService do
  ...
  defp refresh_token_on_cache_miss({:error, _}, credentials, audience), do: refresh_token(credentials, audience)
  defp refresh_token_on_cache_miss({:ok, nil}, credentials, audience), do: refresh_token(credentials, audience)
  ...
  defp refresh_token_unless_it_changed({:ok, _cached_token}, _, credentials, audience) do
    refresh_token(credentials, audience)
  end

  defp refresh_token(credentials, audience) do
